...
function show_order_list() {
    ...
    $.each(resorderlist,function(k,v){
        ...
        if(_end_time >= 0 || v.pingcang_type){
            ...
            html += '<li ng-repeat="o" class="">\
                        <section>\
                            ...
                            <p style="margin: 0" class="ng-binding">金额: <span  class="ng-binding out_money">'+v.fee+'</span>\</p>\
                        ...
                        <section>\
                            <p style="margin: 0px;" class="ng-binding '+closeprice_class+'">'+v.ploss+'</p>\
                            <p style="margin: 0px;" class="ng-binding '+closeprice_class+'">手续费：¥'+v.sx_fee+'</p>\
                            <p style="margin: 0" class="ng-binding '+closeprice_class+'">'+ (v.pingcang_type ? '待平仓' : formatSeconds2(_end_time))+'</p>\
                        </section>\
                        <article class="">\
                        <span class="move_width" style="width: '+(v.pingcang_type ? 100 : baifenbi)+'%; transition-duration: 1s;">\
                        </span>\
                        <i>\
                            <em></em>\
                        </i>\
...
function change_category(type){
  ...
  if(type == 0){
    ...
    timer_orderlist = setInterval('hold_order_list()', 1000);
  }
        ...
        $.each(res_list,function(k,v){
            ...
            html += '<li ng-repeat="o" onclick="get_hold_order('+v.oid+')" >\
                        <section>\
                            ...
                            <p class="ng-binding">'+v.buytime+'</p>\
                        </section><section>\
