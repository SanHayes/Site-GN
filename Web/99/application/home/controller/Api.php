...
class Api extends Controller{
	...
	{		
		...
		foreach ($pro as $k => $v) {
			...
			}elseif(in_array($v['procode'],array(11,12,13,15,23,24,25,26,27,28,29,30,31,33,34,43,96,116))){  	//口袋贵金属
		...
		try{
			...
			foreach ($orderlist as $k => $v) {
				...
				// 		}
				        ...
				        $proloss = mt_rand($arr[0]*100,$arr[1]*100) / 100;
...
/*************黄金白银K线数据开始*****************/	
		...
		}elseif(in_array($pro['procode'],array(11,12,13,15,23,24,25,26,27,28,29,30,31,33,34,43,96,116))){
