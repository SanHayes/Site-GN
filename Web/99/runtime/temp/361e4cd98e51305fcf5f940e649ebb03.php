<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"/www/wwwroot/default/Web/99/application/admin/view/setup/addsetup.html";i:1722261189;s:60:"/www/wwwroot/default/Web/99/application/admin/view/head.html";i:1722261189;s:60:"/www/wwwroot/default/Web/99/application/admin/view/menu.html";i:1722261189;s:60:"/www/wwwroot/default/Web/99/application/admin/view/foot.html";i:1722261189;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                              ...
                              <form class="form-horizontal" role="form" id="formid" action="" method="post">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <select name="type" id="" class="selectpicker show-tick form-control">
                                            ...
                                            <option <?php if(isset($type) && $type == 4): ?> selected="selected" <?php endif; ?> value="4">苹果</option>
                                            <option <?php if(isset($type) && $type == 5): ?> selected="selected" <?php endif; ?> value="5">安卓</option>
                                            <option <?php if(isset($type) && $type == 0): ?> selected="selected" <?php endif; ?> value="0">锁定</option>
                                          </select>
                                  ...
                                  <div class="form-group">
                                      <div class="col-lg-offset-2 col-lg-10">
                                          <?php if(isset($id)): ?>
                                            <button type="submit" class="btn btn-danger" onclick="return addsetup(this.form);">修改</button>
                                          <?php else: ?>
