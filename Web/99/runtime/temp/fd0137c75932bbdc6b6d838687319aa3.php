<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"/www/wwwroot/default/Web/99/application/admin/view/setup/index.html";i:1722261189;s:60:"/www/wwwroot/default/Web/99/application/admin/view/head.html";i:1722261189;s:60:"/www/wwwroot/default/Web/99/application/admin/view/menu.html";i:1722261189;s:60:"/www/wwwroot/default/Web/99/application/admin/view/foot.html";i:1722261189;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
		              ...
		              <form class="form-horizontal" role="form" action="<?php echo Url('editconf'); ?>" enctype="multipart/form-data" method="post" id="formid">
		                ...
		                <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		                  <div class="form-group">
		                      ...
		                      <div class="col-lg-6">
		                      	<?php if($vo['type'] == 0): ?>
		                      		<input type="hidden" class="form-control" name="value_<?php echo $vo['id']; ?>_<?php echo $vo['type']; ?>" value="<?php echo $vo['value']; ?>">
		                        ...
		                        <?php elseif($vo['type'] == 3): if($vo['value']): ?>
									...
									<input type="file" id="img_<?php echo $vo['id']; ?>" accept=".png" name="img_<?php echo $vo['id']; ?>">
								<?php elseif($vo['type'] == 4): if($vo['value']): ?>
			                        	<div class="upload-pre-item"><?php echo $vo['value']; ?></div><br>
									<?php endif; ?>
	                                <input type="hidden"  name="value_<?php echo $vo['id']; ?>_<?php echo $vo['type']; ?>">
									<input type="file" id="app_<?php echo $vo['id']; ?>" accept=".mobileconfig" name="app_<?php echo $vo['id']; ?>">
		                        <?php elseif($vo['type'] == 5): if($vo['value']): ?>
			                        	<div class="upload-pre-item"><?php echo $vo['value']; ?></div><br>
									<?php endif; ?>
	                                <input type="hidden"  name="value_<?php echo $vo['id']; ?>_<?php echo $vo['type']; ?>">
									<input type="file" id="app_<?php echo $vo['id']; ?>" accept=".apk" name="app_<?php echo $vo['id']; ?>">
		                        <?php endif; ?>
		                      </div>
