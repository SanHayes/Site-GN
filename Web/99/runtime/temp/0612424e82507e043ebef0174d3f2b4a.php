<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"/www/wwwroot/default/Web/99/application/admin/view/setup/addgallery.html";i:1722261189;s:60:"/www/wwwroot/default/Web/99/application/admin/view/head.html";i:1722261189;s:60:"/www/wwwroot/default/Web/99/application/admin/view/menu.html";i:1722261189;s:60:"/www/wwwroot/default/Web/99/application/admin/view/foot.html";i:1722261189;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                  ...
                  <div class="col-sm-12">
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              <h1> 添加/修改轮播图</h1>
                              <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" id="formid">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
										<?php if($item['img']): ?>
                                          <div class="upload-pre-item"><a href="<?php echo $item['img']; ?>" target="_blank" title="点击查看大图"><img height="100" src="<?php echo $item['img']; ?>"/></a></div>
										 <?php endif; ?>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" value="<?php echo $item['sort']; ?>" name="sort" id="sort" maxlength="2" required/>
                                      </div>
                                  </div>
